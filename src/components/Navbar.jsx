...
export const Navbar = ({ links }) => {
	...
	return (
		<header
			id="navbar"
			className="fixed h-[60px] z-30 w-full text-gray-700 bg-glass dark-mode:text-gray-200 dark-mode:bg-gray-800"
		>
			<div className="flex flex-col px-4 mx-auto max-w-screen-xl md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
				...
				<nav
					hidden={open}
					className="hidden flex-col flex-grow pb-4 md:pb-0 md:flex md:justify-end md:flex-row"
				>
					{links.map(item => (
						<a
